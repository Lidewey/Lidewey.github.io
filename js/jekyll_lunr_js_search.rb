...
<!-- Add an element to contain the list of search result entries. -->
...
<!-- Create a Mustache template to display the search results. -->
{% raw %}
...
<!-- Configure the jQuery plugin for the search input field. -->
